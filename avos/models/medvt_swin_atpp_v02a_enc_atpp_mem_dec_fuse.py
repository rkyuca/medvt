...
class Transformer(nn.Module):
    ...
    def __init__(self, num_frames, backbone_dims, d_model=384, nhead=8,
        ...
        self.use_atpp = True
        self.use_dec_atpp = False
        if self.use_dec_atpp:
            self.dec_atpp = DecATPP(input_dim=392, model_dim=392, output_dim=392, num_branches=1, use_res=True)
...
class TransformerEncoder(nn.Module):
    ...
    def __init__(self, num_encoder_layers, nhead, dim_feedforward, d_model, dropout, activation, normalize_before,
                 use_cross_layers, cross_pos, num_classes=1):
        super().__init__()
        # ######################################
        # import ipdb; ipdb.set_trace()
...
class TransformerEncoderLayerATPP(nn.Module):
    ...
    def __init__(self, d_model, nhead, dim_feedforward=2048, dropout=0.1,
        ...
        self.cls_attn = nn.MultiheadAttention(embed_dim=384, num_heads=1, kdim=num_classes+2, vdim=d_model, dropout=dropout)
