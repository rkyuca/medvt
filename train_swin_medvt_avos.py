...
def get_args_parser():
    ...
    # Save Paths
    parser.add_argument('--experiment_name', default='medvt_swin_exp_{params_summary}')
    parser.add_argument('--output_dir', default='/local/riemann1/home/rezaul/medvt/swin_medvt_avos/train/',
                        help='save path')
