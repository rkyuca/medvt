...
cfg.TRAIN.PRETRAINED_PVTV2_PATH = "/local/riemann/home/rezaul/model_zoo/medvtplus_release/pretrained_backbones/avsbench/pvt_v2_b5.pth"

###############################
# DATA
cfg.DATA = edict()
cfg.DATA.ANNO_CSV = "/local/riemann/home/rezaul/datasets/avsbench_data/Single-source/s4_meta_data.csv"
cfg.DATA.DIR_IMG = "/local/riemann/home/rezaul/datasets/avsbench_data/Single-source/s4_data/visual_frames"
cfg.DATA.DIR_AUDIO_LOG_MEL = "/local/riemann/home/rezaul/datasets/avsbench_data/Single-source/s4_data/audio_log_mel"
cfg.DATA.DIR_MASK = "/local/riemann/home/rezaul/datasets/avsbench_data/Single-source/s4_data/gt_masks"
