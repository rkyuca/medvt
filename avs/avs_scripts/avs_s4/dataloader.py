...
class S4Dataset(Dataset):
    ...
    def __init__(self, split='train', im_size=None):
    ...
    def __getitem__(self, index):
        ...
        # TODO check for warnings next line
        """
        dataloader.py:55: FutureWarning: Series.__getitem__ treating keys as positions is deprecated. In a future version, integer keys will always be treated as labels (consistent with DataFrame behavior). To access a value by position, use `ser.iloc[pos]`
